...
CREATE TABLE `accessories` (
  `accessory_name` varchar(48) DEFAULT NULL,
...
CREATE TABLE `consoles` (
  `drive_type` varchar(48) DEFAULT NULL,
...
CREATE TABLE `customer` (
  ...
  `customer_code` varchar(9) DEFAULT NULL,
...
CREATE TABLE `games` (
  ...
  `memory_required` int DEFAULT NULL,
...
CREATE TABLE `product_types` (
  `product_type_code` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `products` (
  ...
  `product_name` varchar(48) DEFAULT NULL,
...
-- Dump completed on 2024-12-12 13:52:22
